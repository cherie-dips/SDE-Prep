...
{date:"2026-06-16",theme:"C++ STL & OOP",tasks:[
{t:"Vectors & Arrays",c:"C++",road:"cpp:stl:0"},
...
{date:"2026-06-17",theme:"C++ OOP + Arrays Start",tasks:[
...
{t:"Two Pointers Pattern",c:"DSA",road:"dsa:arrays:0"},
{t:"Sorting Algorithms",c:"DSA",road:"dsa:arrays:1"},
]},
{date:"2026-06-18",theme:"Arrays & Binary Search",tasks:[
...
{t:"Palindrome Problems",c:"DSA",road:"dsa:strings:2"},
]},
{date:"2026-06-20",theme:"Linked Lists & Stacks",tasks:[
...
{date:"2026-06-21",theme:"Queues & Review",tasks:[
...
{t:"Sprint: 5 Medium Problems (Arrays/Strings/Stack)",c:"Practice"},
]},
...
{t:"Tree Traversals (In/Pre/Post)",c:"DSA",road:"dsa:trees:0"},
{t:"Level Order & Zigzag",c:"DSA",road:"dsa:trees:1"},
...
{t:"BFS & DFS on Graphs",c:"DSA",road:"dsa:graphs:0"},
{t:"Cycle Detection",c:"DSA",road:"dsa:graphs:1"},
]},
{date:"2026-06-25",theme:"Graphs Advanced",tasks:[
{t:"Dijkstra's Shortest Path",c:"DSA",road:"dsa:graphs:2"},
{t:"Bellman-Ford Algorithm",c:"DSA",road:"dsa:graphs:3"},
{t:"MST - Prim & Kruskal",c:"DSA",road:"dsa:graphs:4"},
{t:"Topological Sort",c:"DSA",road:"dsa:graphs:5"},
{t:"Union-Find / DSU",c:"DSA",road:"dsa:graphs:6"},
]},
{date:"2026-06-26",theme:"Dynamic Programming",tasks:[
...
{date:"2026-06-27",theme:"Advanced DP & Greedy",tasks:[
{t:"DP on Trees",c:"DSA",road:"dsa:dp:5"},
{t:"Partition DP",c:"DSA",road:"dsa:dp:6"},
{t:"Greedy - Intervals & Activity",c:"DSA",road:"dsa:greedy:0"},
{t:"Greedy - Jump Game, Gas Station",c:"DSA",road:"dsa:greedy:1"},
]},
{date:"2026-06-28",theme:"Tries, Bits & DSA Review",tasks:[
...
{date:"2026-06-29",theme:"LLD - OOP & SOLID",tasks:[
{t:"OOP Concepts Deep Dive",c:"LLD",road:"sysdes:lld:0"},
{t:"Composition vs Inheritance",c:"LLD",road:"sysdes:lld:1"},
{t:"SOLID - SRP & OCP",c:"LLD",road:"sysdes:lld:2"},
{t:"SOLID - LSP, ISP & DIP",c:"LLD",road:"sysdes:lld:3"},
]},
{date:"2026-06-30",theme:"LLD - Design Patterns",tasks:[
...
{date:"2026-07-01",theme:"LLD - Case Studies",tasks:[
{t:"Design Parking Lot",c:"LLD",road:"sysdes:patterns:4"},
{t:"Design BookMyShow",c:"LLD",road:"sysdes:patterns:5"},
{t:"Design Splitwise",c:"LLD",road:"sysdes:patterns:6"},
{t:"Design Elevator System",c:"LLD",road:"sysdes:patterns:7"},
]},
{date:"2026-07-02",theme:"OS - Processes & Scheduling",tasks:[
...
{t:"Round Robin & Priority",c:"OS",road:"os:sched:1"},
{t:"MLFQ & Comparison",c:"OS",road:"os:sched:2"},
]},
{date:"2026-07-03",theme:"OS - Threads & Sync",tasks:[
{t:"Threads & Multithreading Models",c:"OS",road:"os:threads:0"},
{t:"Mutex, Semaphores & Monitors",c:"OS",road:"os:sync:0"},
{t:"Classical Sync Problems",c:"OS",road:"os:sync:1"},
{t:"Deadlock Conditions & Prevention",c:"OS",road:"os:dead:0"},
{t:"Banker's Algorithm",c:"OS",road:"os:dead:1"},
]},
{date:"2026-07-04",theme:"OS - Memory",tasks:[
...
{t:"Thrashing & Working Set",c:"OS",road:"os:vm:1"},
]},
{date:"2026-07-05",theme:"OS - File Systems",tasks:[
{t:"File Allocation Methods",c:"OS",road:"os:fs:0"},
{t:"inode, FAT & Directories",c:"OS",road:"os:fs:1"},
{t:"Disk Scheduling Algorithms",c:"OS",road:"os:fs:2"},
{t:"RAID Levels",c:"OS",road:"os:fs:3"},
{t:"OS Sprint: 20 MCQs",c:"Practice"},
]},
{date:"2026-07-06",theme:"DBMS - ER Model & SQL",tasks:[
{t:"ER Diagrams & Relational Model",c:"DBMS",road:"dbms:er:0"},
{t:"Keys & Constraints",c:"DBMS",road:"dbms:er:1"},
{t:"SQL Basics (DDL, DML, SELECT)",c:"DBMS",road:"dbms:sql:0"},
{t:"Joins (Inner, Outer, Self, Cross)",c:"DBMS",road:"dbms:sql:1"},
{t:"Subqueries & Nested Queries",c:"DBMS",road:"dbms:sql:2"},
]},
{date:"2026-07-07",theme:"DBMS - Advanced SQL & Normal.",tasks:[
{t:"Window Functions",c:"DBMS",road:"dbms:sql:3"},
{t:"Views, Indexes & Procedures",c:"DBMS",road:"dbms:sql:4"},
{t:"Normalization (1NF to BCNF)",c:"DBMS",road:"dbms:norm:0"},
{t:"Denormalization",c:"DBMS",road:"dbms:norm:1"},
]},
{date:"2026-07-08",theme:"DBMS - Transactions & Indexing",tasks:[
{t:"ACID Properties & Isolation Levels",c:"DBMS",road:"dbms:txn:0"},
{t:"Concurrency Control & 2PL",c:"DBMS",road:"dbms:conc:0"},
{t:"B-Tree & B+ Tree Indexing",c:"DBMS",road:"dbms:idx:0"},
{t:"Query Optimization",c:"DBMS",road:"dbms:qopt:0"},
{t:"Recovery & WAL",c:"DBMS",road:"dbms:recov:0"},
]},
{date:"2026-07-09",theme:"CN - Models & Data Link",tasks:[
...
{date:"2026-07-10",theme:"CN - Network & Transport",tasks:[
{t:"IPv4 Addressing & Subnetting",c:"CN",road:"cn:net:0"},
{t:"Routing Protocols",c:"CN",road:"cn:net:1"},
{t:"TCP Handshake & Flow Control",c:"CN",road:"cn:trans:0"},
{t:"TCP Congestion & UDP",c:"CN",road:"cn:trans:1"},
]},
{date:"2026-07-11",theme:"CN - Application & Security",tasks:[
{t:"HTTP/HTTPS & DNS",c:"CN",road:"cn:app:0"},
{t:"DHCP, FTP, SMTP & WebSockets",c:"CN",road:"cn:app:1"},
{t:"SSL/TLS & Firewalls",c:"CN",road:"cn:sec:0"},
{t:"Common Network Attacks",c:"CN",road:"cn:sec:1"},
]},
{date:"2026-07-12",theme:"CS Fundamentals Review",tasks:[
...
{date:"2026-07-13",theme:"MERN - HTML, CSS & JS",tasks:[
{t:"HTML5 & Semantic Elements",c:"MERN",road:"mern:html:0"},
{t:"CSS Flexbox & Grid",c:"MERN",road:"mern:html:1"},
{t:"JavaScript ES6+ Features",c:"MERN",road:"mern:js:0"},
{t:"Closures, Promises & Async",c:"MERN",road:"mern:js:1"},
{t:"Event Loop & Prototypes",c:"MERN",road:"mern:js:2"},
]},
{date:"2026-07-14",theme:"React.js",tasks:[
{t:"Components, JSX & Props",c:"MERN",road:"mern:react:0"},
{t:"Hooks (useState, useEffect)",c:"MERN",road:"mern:react:1"},
{t:"Context API & Router",c:"MERN",road:"mern:react:2"},
{t:"Performance & Custom Hooks",c:"MERN",road:"mern:react:3"},
]},
{date:"2026-07-15",theme:"Node.js & Backend",tasks:[
{t:"Node.js & Express Basics",c:"MERN",road:"mern:node:0"},
{t:"REST API Design",c:"MERN",road:"mern:node:1"},
{t:"Authentication (JWT, OAuth)",c:"MERN",road:"mern:node:2"},
{t:"MongoDB CRUD & Aggregation",c:"MERN",road:"mern:mongo:0"},
]},
{date:"2026-07-16",theme:"Advanced Backend",tasks:[
{t:"Mongoose & Schema Design",c:"MERN",road:"mern:mongo:1"},
{t:"Error Handling & Validation",c:"MERN",road:"mern:node:3"},
{t:"File Uploads & Security",c:"MERN",road:"mern:node:4"},
]},
{date:"2026-07-17",theme:"DevOps",tasks:[
{t:"Git Branching & Workflows",c:"MERN",road:"mern:devops:0"},
{t:"Docker & Dockerfile",c:"MERN",road:"mern:devops:1"},
{t:"Docker Compose & K8s Basics",c:"MERN",road:"mern:devops:2"},
{t:"CI/CD with GitHub Actions",c:"MERN",road:"mern:devops:3"},
]},
{date:"2026-07-18",theme:"Cloud & Deployment",tasks:[
{t:"AWS EC2, S3 & Lambda",c:"MERN",road:"mern:cloud:0"},
{t:"Nginx & Reverse Proxy",c:"MERN",road:"mern:cloud:1"},
{t:"Deployment Platforms",c:"MERN",road:"mern:cloud:2"},
]},
{date:"2026-07-19",theme:"Full Stack Review",tasks:[
{t:"Build Mini Full Stack App",c:"MERN"},
{t:"MERN Sprint: 15 MCQs",c:"Practice"},
{t:"DSA: 3 Medium Problems",c:"Practice"},
]},
{date:"2026-07-20",theme:"DSA Sprint - Linear",tasks:[
...
{date:"2026-07-21",theme:"DSA Sprint - Advanced",tasks:[
...
{date:"2026-07-22",theme:"Mock Interview Day 1",tasks:[
...
{date:"2026-07-25",theme:"Speed Coding Sprint",tasks:[
{t:"Speed: 10 Easy in 60 min",c:"Practice"},
{t:"Speed: 5 Medium in 75 min",c:"Practice"},
{t:"Review: All DSA Pattern Templates",c:"Review"},
]},
{date:"2026-07-26",theme:"CS Review Sprint",tasks:[
...
{date:"2026-07-27",theme:"Hard Problem Marathon",tasks:[
...
{date:"2026-07-28",theme:"Final CS Review",tasks:[
{t:"Final Review: OS (2 hrs)",c:"Review"},
{t:"Final Review: DBMS (1.5 hrs)",c:"Review"},
{t:"Final Review: CN (1.5 hrs)",c:"Review"},
{t:"DSA: 3 Medium Speed Round",c:"Practice"},
]},
{date:"2026-07-29",theme:"Full Mock Simulation",tasks:[
{t:"Mock: DE Shaw Online (3 DSA + 25 MCQs, 90 min)",c:"Practice"},
{t:"Mock: Technical Interview (60 min)",c:"Practice"},
{t:"Analysis: Final Error Review",c:"Review"},
]},
{date:"2026-07-30",theme:"DE Shaw Specific",tasks:[
{t:"DE Shaw Past Questions (GFG, Glassdoor)",c:"Practice"},
{t:"String Parsing & Math Problems",c:"Practice"},
{t:"Explain Projects Technically",c:"Practice"},
{t:"Probability & Aptitude Basics",c:"Review"},
]},
{date:"2026-07-31",theme:"Final Sprint",tasks:[
{t:"Solve: 5 Medium (one per topic)",c:"Practice"},
{t:"Review: All Cheat Sheets",c:"Review"},
{t:"Review: Top 10 DSA Patterns",c:"Review"},
]},
{date:"2026-08-01",theme:"ML & Supervised Learning",tasks:[
{t:"Regression & Classification",c:"GenAI",road:"genai:mlf:0"},
{t:"Metrics & Bias-Variance",c:"GenAI",road:"genai:mlf:1"},
{t:"Decision Trees & Random Forest",c:"GenAI",road:"genai:sup:0"},
{t:"SVM & Gradient Boosting",c:"GenAI",road:"genai:sup:1"},
]},
{date:"2026-08-02",theme:"Deep Learning",tasks:[
{t:"Neural Networks & Backprop",c:"GenAI",road:"genai:dl:0"},
{t:"Optimizers & Regularization",c:"GenAI",road:"genai:dl:1"},
{t:"CNN & Image Classification",c:"GenAI",road:"genai:cnn2:0"},
{t:"RNN, LSTM & Sequences",c:"GenAI",road:"genai:seq:0"},
]},
{date:"2026-08-03",theme:"NLP & Transformers",tasks:[
{t:"Tokenization & Embeddings",c:"GenAI",road:"genai:nlp:0"},
{t:"TF-IDF & Text Classification",c:"GenAI",road:"genai:nlp:1"},
{t:"Attention & Transformer Architecture",c:"GenAI",road:"genai:llm:0"},
{t:"BERT, GPT & Fine-tuning",c:"GenAI",road:"genai:llm:1"},
]},
{date:"2026-08-04",theme:"RAG & Applications",tasks:[
{t:"Vector DBs & Embeddings",c:"GenAI",road:"genai:rag:0"},
{t:"Chunking & Retrieval Pipeline",c:"GenAI",road:"genai:rag:1"},
{t:"LangChain & Evaluation",c:"GenAI",road:"genai:rag:2"},
{t:"Prompt Engineering",c:"GenAI",road:"genai:llm:2"},
]},
{date:"2026-08-05",theme:"Aptitude & Reasoning",tasks:[
{t:"Probability & Combinatorics",c:"Aptitude",road:"apt:prob:0"},
{t:"Logical Reasoning & Puzzles",c:"Aptitude",road:"apt:prob:1"},
{t:"Quantitative Aptitude",c:"Aptitude",road:"apt:quant:0"},
{t:"Practice: 30 Mixed Problems",c:"Practice"},
]},
...
{date:"2026-08-07",theme:"Confidence Day",tasks:[
{t:"Light Review: All Cheat Sheets (30 min)",c:"Review"},
{t:"Solve: 3 Easy for Confidence",c:"Practice"},
{t:"Review: Top 10 Patterns",c:"Review"},
]},
];
